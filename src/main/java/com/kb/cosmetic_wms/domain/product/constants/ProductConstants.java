...
public final class ProductConstants {
    ...
    public static final String INVALID_PRODUCT_PRICE_MESSAGE = "상품 가격은 0원 이상이어야 합니다.";
    public static final String TEMPERATURE_TYPE_REQUIRED_MESSAGE = "보관 온도 타입은 필수 입력 항목입니다.";

    public static final String INVALID_SEQUENCE_MIN_MESSAGE = "SKU 일련번호 순번은 1 이상이어야 합니다.";
    public static final String INVALID_SEQUENCE_MAX_MESSAGE = "SKU 일련번호는 9999를 초과할 수 없습니다.";
