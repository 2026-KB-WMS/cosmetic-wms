...
import com.kb.cosmetic_wms.oms.domain.service.DrivingDistanceProvider;
...
class WeightBasedAssignmentPolicyTest {
    ...
    class FEFO_가중치 {
        ...
        void 임박_재고_보유_창고가_충분히_가까우면_최근접_창고보다_우선될_수_있다() {
            // 김포(가까움, 신선 재고) vs 대전(중간, 30일 임박 재고)
            // 거리 점수 차이(0.5 가중치)가 FEFO 점수 차이(0.3 가중치)보다 커서 김포가 이긴다
